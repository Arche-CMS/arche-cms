...
import type { AdminProvider } from "../../../src/admin/lib/providers/types";

/**
 * Provider contract test.
 *
 * This file verifies that a provider implementation satisfies the
 * AdminProvider interface at the type level. The REST provider must
 * pass these structural checks.
 *
...
describe("REST provider contract", () => {
  ...
  it("createRestProvider returns a valid AdminProvider", async () => {
    const { createRestProvider } = await import("../../../src/admin/lib/providers/rest");
