...
function generateSdkFile(options: GenerationOptions): string {
  const lines: string[] = [
    ...
    "",
    'import { createClient, type ArcheClient } from "@arche-cms/sdk";',
    "",
  ];
  ...
  lines.push("): ArcheClient {");
  lines.push("  return createClient(config);");
  lines.push("}");
  lines.push("");
...
export const sdkGenerator: Generator = {
  description: "Generates typed SDK client with collection/global type maps",
